...
<div class="container">
    ...
    <div class="row card-group-row mb-lg-8pt" style="margin: 20px;">
      @if($courses->count() > 0)
        @foreach ($courses as $course)
            <div class="col-md-3 card-group-row__col">
                <div class="card card-sm card--elevated p-relative o-hidden overlay overlay--primary-dodger-blue js-overlay card-group-row__card w-80 h-80">
                    ...
                    <!-- Course Image -->
                    <a href="{{ route('student.lessons.showLessons', $course->id) }}" class="card-img-top js-image" data-position="" data-height="140">
                    ...
                    <div class="card-body flex">
                        <a class="card-title" href="{{ route('student.lessons.showLessons', $course->id) }}">{{ $course->name }}</a>
